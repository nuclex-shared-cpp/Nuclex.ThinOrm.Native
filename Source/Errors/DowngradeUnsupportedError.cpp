...
namespace Nuclex::ThinOrm::Errors {
  ...
  DowngradeUnsupportedError::DowngradeUnsupportedError(const std::u8string &message) noexcept :
    std::logic_error(
      std::string(
  ...
  DowngradeUnsupportedError::DowngradeUnsupportedError(const char8_t *message) noexcept :
